...
def test_viterbi_decoder_round_trip_short():
    """
    Happy path: kratki niz.
    Encoder + decoder moraju vratiti isti niz.
    """
...
def test_viterbi_decoder_round_trip_long():
    """
    Happy path: duži niz.
    Encoder + decoder moraju vratiti isti niz.
    """
...
def test_viterbi_decoder_round_trip_random():
    """
    Happy path: slučajni niz.
    Encoder + decoder moraju vratiti isti niz.
    """
